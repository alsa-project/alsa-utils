/*
 *  aseqsend.c - send hex encoded MIDI messages to selected ALSA MIDI seqencer port
 *
...
{
	printf(
		"\nUsage: aseqsend options [hex encoded bytes]\n\n"
		"         -h  this help\n"
		"         -V  print current version\n"
		"         -v  verbose\n"
		"         -l  list all seqencer ports\n"
...
int main(int argc, char *argv[])
{
	...
	while ((c = getopt(argc, argv, "hVvlp:")) != -1) {
		switch (c) {
		case 'h':
			usage();
			return 0;
