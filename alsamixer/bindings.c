...
command_enum mixer_bindings[] = {
	...
	['r'] =				CMD_MIXER_REFRESH,
	['R'] =				CMD_MIXER_REFRESH,
	['g'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 0),
	['G'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 100),
	['!'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 0),
	...
	[ALT('1')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 0),
	[ALT('2')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 1),
	[ALT('3')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 2),
	[ALT('4')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 3),
	[ALT('5')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 4),
	[ALT('6')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 5),
	[ALT('7')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 6),
	[ALT('8')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 7),
	[ALT('9')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 8),
	[ALT('0')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS_N, 9),
};
