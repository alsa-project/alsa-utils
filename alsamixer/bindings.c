...
command_enum mixer_bindings[] = {
	...
	[']'] =				CMD_WITH_ARG(CMD_MIXER_NEXT, 1),
	['}'] =				CMD_WITH_ARG(CMD_MIXER_NEXT, 1),
	['['] =				CMD_WITH_ARG(CMD_MIXER_PREVIOUS, 1),
	['{'] =				CMD_WITH_ARG(CMD_MIXER_PREVIOUS, 1),
	['r'] =				CMD_MIXER_REFRESH,
	['R'] =				CMD_MIXER_REFRESH,
	['g'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 0),
	['G'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 100),
	['!'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 0),
	['@'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 1),
	['#'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 2),
	['$'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 3),
	['%'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 4),
	['^'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 5),
	['&'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 6),
	['*'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 7),
	['('] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 8),
	[')'] =				CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 9),
	[ALT('1')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 0),
	[ALT('2')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 1),
	[ALT('3')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 2),
	[ALT('4')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 3),
	[ALT('5')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 4),
	[ALT('6')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 5),
	[ALT('7')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 6),
	[ALT('8')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 7),
	[ALT('9')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 8),
	[ALT('0')] =		CMD_WITH_ARG(CMD_MIXER_CONTROL_FOCUS, 9),
};
